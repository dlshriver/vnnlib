...
def test_box_poly_or(tmp_path):
    ...
    assert all(result[0][1][1][0][0] == [-1, 0])
    assert all(result[0][1][1][1][0] == [1000])
...
def test_box_poly_dnf_1(tmp_path):
    ...
    assert len(result[0][1][1]) == 2
    assert all(result[0][1][1][0][0] == [-1, 0])
    assert all(result[0][1][1][0][1] == [0, 1])
    assert all(result[0][1][1][1][0] == [1000])
    assert all(result[0][1][1][1][1] == [-1010])
